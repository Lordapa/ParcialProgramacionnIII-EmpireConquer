...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiguelBeneditProgramacion3_Core.Entities.City", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MiguelBeneditProgramacion3_Core.Entities.Empire", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MiguelBeneditProgramacion3_Core.Entities.Game", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MiguelBeneditProgramacion3_Core.Entities.Ground", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MiguelBeneditProgramacion3_Core.Entities.Map", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MiguelBeneditProgramacion3_Core.Entities.Quest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MiguelBeneditProgramacion3_Core.Entities.Region", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MiguelBeneditProgramacion3_Core.Entities.City", b =>
                {
                    b.HasOne("MiguelBeneditProgramacion3_Core.Entities.Empire", "Empire")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("MiguelBeneditProgramacion3_Core.Entities.Empire", b =>
                {
                    b.HasOne("MiguelBeneditProgramacion3_Core.Entities.Game", null)
                        .WithMany("Empires")
                        .HasForeignKey("GameId");

                    b.HasOne("MiguelBeneditProgramacion3_Core.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("MiguelBeneditProgramacion3_Core.Entities.Game", b =>
                {
                    b.HasOne("MiguelBeneditProgramacion3_Core.Entities.Map", "Map")
                        .WithMany()
                        .HasForeignKey("MapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MiguelBeneditProgramacion3_Core.Entities.Ground", b =>
                {
                    b.HasOne("MiguelBeneditProgramacion3_Core.Entities.Region", null)
                        .WithMany("Grounds")
                        .HasForeignKey("RegionId");
                });
